...
public class StudentDAOTest {
	...
	@Test	
	public void getStudentToFirstName() {
		StudentDAO studentDAO = new StudentDAO();
		Student result = (Student) studentDAO.getStudentToFirstName(student.getFirstName());	
		assertEquals("Alex", result.getFirstName());
		
	}
	
	@Test	
	   public void getStudentToSecondName() {
		StudentDAO studentDAO = new StudentDAO();
		Student result = (Student) studentDAO.getStudentToSecondName(student.getSecondName());	
		assertEquals("Pupkin", result.getSecondName());
	}
	
	@Test
	public void getStudentToAge() {
		StudentDAO studentDAO = new StudentDAO();
		Student result = (Student) studentDAO.getStudentToAge(student.getAge());
